...
for cls in clses:
    ...
    if not os.path.exists("datasets/ultradoman/questions"):
        os.makedirs("datasets/ultradoman/questions")

    file_path = f"datasets/ultradoman/questions/{cls}_questions.txt"
