...
if __name__ == "__main__":
    ...
    if not os.path.exists(f"output_qual/ultradoman/{cls}"):
        os.makedirs(f"output_qual/ultradoman/{cls}")    
    
    run_queries_and_save_to_json(
        queries, rag, query_param, f"output_qual/ultradoman/{cls}/{cls}_result.json", f"output_qual/ultradoman/{cls}/{cls}_errors.json"
    )
